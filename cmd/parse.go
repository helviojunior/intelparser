...
func init() {
	...
	parserCmd.PersistentFlags().BoolVar(&opts.DisableUrl, "disable-url", false, "Disable URL's indexes")
	parserCmd.PersistentFlags().BoolVar(&opts.DisableEmail, "disable-email", false, "Disable E-mail's indexes")
}
